...
const GUIDE = [
  ...
  },
  {
    ...
    tags: 'đề thi thi online trắc nghiệm mã thi qr quét mã tự chấm câu hỏi custom tự soạn preview tải đề pdf docx phòng chờ bắt đầu thi kết thúc rời màn hình cảnh báo mở thi lại thi bù xáo trộn hệ số thời lượng bảng điểm chọn tên',
    summary: 'Soạn đề trắc nghiệm (chọn từ ngân hàng hoặc tự soạn), cho học viên quét mã vào thi online. Giáo lý viên điều khiển từng bước, thấy được khi các em rời màn hình, hệ thống tự chấm và ghi thẳng điểm vào bảng điểm của lớp.',
    steps: [
      'Bước 1 - Tạo đề: vào “Đề thi”, bấm “Soạn đề thi”. Điền “Tên đề”, chọn “Lớp thi”, chọn “Loại bài” (mỗi loại đã gắn sẵn hệ số điểm), và nhập “Thời lượng” tính bằng phút. Để “Thời lượng” là 0 nếu không giới hạn giờ làm bài.',
      'Bước 2 - Lấy câu hỏi từ ngân hàng: ở tab “Ngân hàng câu hỏi”, tích chọn các câu có sẵn để đưa vào đề. Các câu đã chọn nằm ở tab “Câu hỏi trong đề”.',
      'Bước 3 - Tự soạn câu hỏi (tùy chọn): bấm “Thêm câu tự soạn”, nhập nội dung câu hỏi, thêm từ 2 đến 6 đáp án, rồi chấm ô tròn ở đúng đáp án ĐÚNG. Mọi câu hỏi, dù lấy từ ngân hàng hay tự soạn, đều sửa lại hoặc xóa được trước khi tạo đề.',
      'Bước 4 - Lưu đề: bấm nút tạo đề. Đề được lưu ở dạng nháp, chưa mở cho ai vào. Nếu cần bản giấy, có thể dùng “In đề” cho học viên hoặc “In đáp án (GLV)” cho giáo lý viên, xuất ra PDF.',
      'Bước 5 - Mở phòng chờ: mở đề vừa tạo, bấm “Mở phòng chờ”. Màn hình sẽ hiện mã thi và mã QR để chiếu lên cho cả lớp.',
      'Bước 6 - Các em vào phòng: hướng dẫn các em dùng điện thoại quét mã QR (hoặc mở link rồi nhập mã thi). Sau đó các em “chọn đúng tên mình” trong danh sách lớp và bấm “Vào phòng thi”. Vào xong các em ở màn hình chờ, chưa thấy đề.',
      'Bước 7 - Bắt đầu thi: khi các em đã chọn tên và vào phòng chờ đầy đủ, giáo lý viên mới bấm “Bắt đầu thi”. Lúc đó đề mới mở ra cho các em làm. Thứ tự câu hỏi và đáp án được xáo trộn khác nhau cho từng em nên ngồi cạnh nhau cũng không nhìn bài được.',
      'Bước 8 - Theo dõi khi thi: bảng danh sách hiện em nào “Đang làm”, em nào “Đã nộp”. Nếu một em thoát ra màn hình khác lúc làm bài (mở app khác, nhắn tin...), hệ thống ghi lại và hiện cột “Rời MH” kèm số lần và dấu ⚠ để giáo lý viên nhắc nhở. Trên máy em đó cũng hiện dòng cảnh báo đã rời màn hình bao nhiêu lần.',
      'Bước 9 - Kết thúc và công bố: khi các em nộp xong, bấm “Kết thúc”. Hệ thống tự chấm ngay và ghi điểm thẳng vào bảng điểm của lớp theo hệ số đã đặt, không cần chấm tay. Nếu có đặt “Thời lượng”, bài sẽ tự nộp khi hết giờ.',
      'Bước 10 - Xem lại bài: sau khi công bố, mỗi em xem được điểm của mình và xem lại từng câu (đáp án đúng là gì, mình chọn đúng hay sai). Giáo lý viên bấm vào một em trong bảng để xem lại bài làm của em đó.',
      'Bước 11 - Cho em vắng thi bù: nếu có em chưa kịp thi, bấm “Mở thi lại (cho em vắng)” để mở lại cho những em đó vào làm. Điểm thi bù được gộp vào đúng cột điểm cũ.',
    ],
    tips: [
      'Chỉ bấm “Bắt đầu thi” khi các em đã chọn tên và vào phòng chờ đủ, để không em nào bị lỡ.',
      'Câu hỏi và đáp án xáo trộn riêng cho từng em, các em ngồi cạnh nhau vẫn thấy thứ tự khác nhau.',
      'Số lần “Rời MH” chỉ để nhắc nhở, hệ thống không tự trừ điểm; giáo lý viên tự cân nhắc.',
      'Tự soạn câu hỏi sát bài đã dạy để kiểm tra đúng trọng tâm của lớp mình.',
      'Để “Thời lượng” là 0 nếu muốn chủ động bấm “Kết thúc”; đặt số phút > 0 nếu muốn bài tự nộp khi hết giờ.',
    ],
  },
  {
