      ...
      <div className="modal wide" onClick={(e) => e.stopPropagation()}>
        ...
        {!editing ? (
          ...
          <>
            ...
            <div className="field"><label>Link chơi (URL)</label><input value={editing.url || ''} onChange={(e) => setEditing({ ...editing, url: e.target.value })} placeholder="https://wecatholic.com/..." /></div>
            <div className="row">
              <div className="field">
